...
emote_list: list[tuple[list[str], str, float]] = [
    ...
    (['1', 'zombie', 'ZOMBIE', 'Zombie'], 'idle_zombie', 28.75),
    (['2', 'relaxed', 'RElAXED', 'Relaxed'], 'idle_layingdown2', 20.55),
    (['3', 'attentive', 'att', 'Attentive'], 'idle_layingdown', 23.55),
    (['4', 'sleepy', 'SlEEPY', 'Sleepy'], 'idle-sleep', 22.62),
    (['5', 'pouty', 'POUT', 'Pouty', 'Pouty Face'], 'idle-sad', 24.38),
    (['6', 'posh', 'POSH', 'Posh'], 'idle-posh', 21.85),
    (['7', 'tired', 'Tired', 'Tired'], 'idle-loop-tired', 21.96),
    (['8', 'laploop', 'TapLoop', 'TapLoop'], 'idle-loop-tapdance', 6.26),
    (['9', 'shy', 'SHY', 'Shy'], 'idle-loop-shy', 16.47),
    (['10', 'bummed', 'BUMMED', 'Bummed'], 'idle-loop-sad', 6.05),
    (['11', 'Chill', 'chill', "chillin'", "Chillin'"], 'idle-loop-happy', 18.80),
    (['12', 'annoyed', 'annoyed', 'Annoyed'], 'idle-loop-annoyed', 17.06),
    (['13', 'aerobics', 'aerobic', 'Aerobics'], 'idle-loop-aerobics', 8.51),
    (['14', 'lookup', 'Loopup', 'ponder', 'Ponder'], 'idle-lookup', 22.34),
    (['15', 'heropose', 'Hero', 'Heropose', 'hero', 'Hero Pose'], 'idle-hero', 21.88),
    (['16', 'relaxing', 'RElAXING', 'Relaxing'], 'idle-floorsleeping2', 16.25),
    (['17', 'cozynap', 'nap', 'Nap', 'Cozynap', 'Cozy Nap'], 'idle-floorsleeping', 13.00),
    (['18', 'enthused', 'enthus', 'Enthused'], 'idle-enthusiastic', 15.94),
    (['19', 'beat', 'feelbeat', 'FeelTheBeat'], 'idle-dance-headbobbing', 25.37),
    (['20', 'irritated', 'irritat', 'Irritated'], 'idle-angry', 25.43),
    (['21', 'fly', 'Fly', 'I Believe I Can Fly'], 'emote-wings', 13.13),
    (['22', 'think', 'Think'], 'emote-think', 3.69),
    (['23', 'theatrical', 'theatric', 'Theatrical'], 'emote-theatrical', 8.59),
    (['24', 'tapdance', 'tap dance', 'TapDance'], 'emote-tapdance', 11.06),
    (['25', 'superrun', 'Superrun', 'Super Run'], 'emote-superrun', 6.27),
    (['26', 'super punch', 'superpunch', 'Superpunch', 'Super Punch'], 'emote-superpunch', 3.75),
    (['27', 'sumo', 'Sumo', 'Sumo Fight'], 'emote-sumo', 10.87),
    (['28','thumb suck', 'thumbsuck', 'Thumb suck', 'suckthumb'], 'emote-suckthumb', 4.19),
    (['35', '29', 'splits drop', 'Splits drop', 'splits'], 'emote-splitsdrop', 4.47),
    (['36', '30', 'snowball fight', 'Snowball fight', 'snowball'], 'emote-snowball', 5.23),
    (['37', '31', 'snow angel', 'Snow angel', 'angel'], 'emote-snowangel', 6.22),
    (['39', '32', 'secret handshake', 'Secret handshake', 'handshake'], 'emote-secrethandshake', 3.88),
    (['41', 'rope pull', 'Rope pull', 'rope'], 'emote-ropepull', 8.77),
    (['42', '33', 'roll', 'Roll'], 'emote-roll', 3.56),
    (['43', 'rofl', 'ROFL'], 'emote-rofl', 6.31),
    (['44', 'robot', 'Robot'], 'emote-robot', 7.61),
    (['45', '34', 'rainbow', 'Rainbow'], 'emote-rainbow', 2.81),
