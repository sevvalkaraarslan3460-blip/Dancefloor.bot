...
class xenoichi(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if user.username == "raymg" or "JN_JUNGKOOK" or "rythm" or "prettyeyedjenn" or "LatinStar" or "codexne" or "Obito153" or "prettyeyedjenn" or "CHARLEZangel1" or "XCheekyX":
            ...
            if message.startswith("/help"):
                ...
                await self.highrise.chat(f"dancefloor.")
